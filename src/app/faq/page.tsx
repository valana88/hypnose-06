...
const faqs = [
  ...
  {
    q: 'Est-ce remboursé ?',
    a: 'L\'hypnose n\'est pas remboursée par la Sécurité sociale. Certaines mutuelles prennent en charge tout ou partie des séances, renseignez-vous auprès de la vôtre.',
  },
  {

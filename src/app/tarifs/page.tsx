    ...
    <>
        ...
        >
          {tarifs.map((t) => (
            ...
            >
              ...
              <p style={{ fontSize: '0.875rem', color: '#5C6657' }}>
                {t.note}
              </p>
            </div>
          ))}
      ...
      <Section tone="sand" narrow eyebrow="Bon à savoir">
        <ul style={{ listStyle: 'none', lineHeight: 2 }}>
          ...
          <li>
            — Une facture peut vous être remise sur simple demande
          </li>
          <li>
            — Les séances ne sont pas remboursées par la Sécurité sociale
          </li>
          <li>
            — Certaines mutuelles prennent en charge tout ou partie des
            séances : renseignez-vous auprès de la vôtre
          </li>
          <li>
            — Annulation possible jusqu&apos;à 24 h avant le rendez-vous
          </li>
        </ul>
      </Section>
